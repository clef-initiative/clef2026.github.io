...
{{< figure src="img/clef26-speakers-verbene.jpg" size="400x500" float="right" classes="w-64 pl-8" width="sm"  caption="Lucie Flek" >}}
...
{{< figure src="img/clef26-speakers-granitzer.jpg" size="400x500" float="right" classes="w-64 pl-8" width="sm"  caption="Lucie Flek" >}}
